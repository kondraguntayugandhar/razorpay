...
import { QrCode, Smartphone, ArrowLeft, RefreshCw, ShieldCheck } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const initPayment = async () => {
      try {
        ...
        // 1. Fetch from URL parameter or session storage or create new payment
        if (paymentIdParam) {
        ...
        // Set mock fallback payment object for UI display
    ...
    <div className="min-h-screen pb-12">
      ...
      <main className="max-w-xl mx-auto px-4">
        ...
        <Card className="text-center py-6">
          ...
          {/* Mobile App Chooser Section (Intent URI) */}
